...
(train_data, y_train, train_users, train_items) = loadData("/content/drive/My Drive/task/aspect_based_rs/data/amazon_toys_games/amazon_toys_games.train.data")
(val_data, y_val, val_users, val_items) = loadData("/content/drive/My Drive/task/aspect_based_rs/data/amazon_toys_games/amazon_toys_games.val.data")
(test_data, y_test, test_users, test_items) = loadData("/content/drive/My Drive/task/aspect_based_rs/data/amazon_toys_games/amazon_toys_games.test.data")
v = DictVectorizer()
