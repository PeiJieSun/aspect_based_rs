...
if __name__ == '__main__':
    ...
    ########################### FIRST TRAINING #####################################
    log = Logging('/content/drive/My Drive/task/aspect_based_rs/out/amazon_movies_tv/train_amazon_movies_tv_pmf_id_x.log')
    train_model_path = '/content/drive/My Drive/task/aspect_based_rs/out/amazon_movies_tv/train_amazon_movies_tv_pmf_id_x.mod'
    ...
    for epoch in range(1, conf.train_epochs+1):
        ...
        for batch_idx_list in train_batch_sampler:
            ...
            _, loss = model(user_list, item_list, rating_list)
