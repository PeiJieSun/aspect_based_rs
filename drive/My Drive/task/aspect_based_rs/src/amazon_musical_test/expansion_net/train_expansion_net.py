...
if __name__ == '__main__':
    ...
    log = Logging('%s/train_%s_expansion_net_id_X3.py' % (conf.out_path, conf.data_name))
    train_model_path = '%s/train_%s_expansion_net_id_X3' % (conf.out_path, conf.data_name)
