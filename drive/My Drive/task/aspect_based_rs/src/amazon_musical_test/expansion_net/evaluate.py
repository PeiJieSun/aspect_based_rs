...
def evaluate(test_dataset, test_batch_sampler, model, review_aspect, review_aspect_mask):
    bleu_score = []
    ...
    for batch_idx_list in test_batch_sampler:
        ...
        sample_idx_list = model._sample_text_by_top_one(user, item, summary, review_input, review_aspect, review_aspect_mask)
