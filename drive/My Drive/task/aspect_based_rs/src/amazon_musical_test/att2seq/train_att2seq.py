...
import DataModule_att2seq as data_utils
...
if __name__ == '__main__':
    ...
    log = Logging('%s/train_%s_att2seq_id_X.py' % (conf.out_path, conf.data_name))
    train_model_path = '%s/train_%s_att2seq_id_X' % (conf.out_path, conf.data_name)
