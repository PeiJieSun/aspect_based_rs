...
class decoder(nn.Module):
    def __init__(self):
        ...
        self.linear_eq_12 = nn.Linear(1*conf.aspect_dim+0*conf.word_dim+0*conf.hidden_dim, conf.aspect_dim)
        self.linear_eq_13 = nn.Linear(conf.hidden_dim+0*conf.att_dim, conf.vocab_sz)
