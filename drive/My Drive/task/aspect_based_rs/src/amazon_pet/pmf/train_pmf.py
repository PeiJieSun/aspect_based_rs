...
if __name__ == '__main__':
    ...
    for epoch in range(1, conf.train_epochs+1):
        ...
        for batch_idx_list in train_batch_sampler:
            ...
            prediction, rating_loss, obj_loss = model(user_list, item_list, rating_list)
            #import pdb; pdb.set_trace()
            train_loss.extend(tensorToScalar(rating_loss))
        ...
        for batch_idx_list in val_batch_sampler:
            ...
            prediction, rating_loss, _ = model(user_list, item_list, rating_list)    
            val_loss.extend(tensorToScalar(rating_loss))
        ...
        for batch_idx_list in test_batch_sampler:
            ...
            prediction, rating_loss, _ = model(user_list, item_list, rating_list)    
            test_loss.extend(tensorToScalar(rating_loss))
