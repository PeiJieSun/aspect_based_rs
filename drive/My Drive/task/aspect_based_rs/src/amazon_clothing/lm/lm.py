...
class lm(nn.Module): 
    ...
    def forward(self, user_list, item_list, review_input_list, review_target_list):
        ...
        out_loss = F.cross_entropy(word_probit, review_target_list.reshape(-1), reduction='none')
        obj = F.cross_entropy(word_probit, review_target_list.reshape(-1))
