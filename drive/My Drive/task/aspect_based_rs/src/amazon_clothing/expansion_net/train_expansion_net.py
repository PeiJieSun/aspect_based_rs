...
if __name__ == '__main__':
    ...
    #model.load_state_dict(torch.load('/content/drive/My Drive/task/aspect_based_rs/out/model/train_amazon_clothing_expansion_net_id_31.mod'))
    model.cuda()
    ...
    log = Logging('%s/train_%s_expansion_net_id_32.py' % (conf.out_path, conf.data_name))
    train_model_path = '%s/train_%s_expansion_net_id_32.mod' % (conf.out_path, conf.data_name)
