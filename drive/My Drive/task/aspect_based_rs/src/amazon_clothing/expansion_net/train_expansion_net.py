...
if __name__ == '__main__':
    ...
    log = Logging('%s/train_%s_expansion_net_id_26.py' % (conf.out_path, conf.data_name))
    train_model_path = '%s/train_%s_expansion_net_id_26.mod' % (conf.out_path, conf.data_name)
