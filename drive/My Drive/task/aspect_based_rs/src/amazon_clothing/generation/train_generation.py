...
if __name__ == '__main__':
    ...
    log = Logging('%s/train_%s_aspect_generation_id_01.py' % (conf.out_path, conf.data_name))
    train_model_path = '%s/train_%s_aspect_generation_id_01.mod' % (conf.out_path, conf.data_name)
