...
if __name__ == '__main__':
    ...
    log = Logging('%s/train_%s_aspect_rating_1_id_adabound_14.py' % (conf.out_path, conf.data_name))
    train_model_path = '%s/train_%s_aspect_rating_1_id_adabound_14.mod' % (conf.out_path, conf.data_name)
