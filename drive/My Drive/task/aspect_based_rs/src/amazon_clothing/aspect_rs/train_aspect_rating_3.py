...
if __name__ == '__main__':
    ...
    log = Logging('%s/train_%s_aspect_rating_3_id_60.py' % (conf.out_path, conf.data_name))
    train_model_path = '%s/train_%s_aspect_rating_3_id_60.mod' % (conf.out_path, conf.data_name)
    ...
    for epoch in range(1, conf.train_epochs+1):
        ...
        for batch_idx_list in train_batch_sampler:
            user_list, item_list, rating_list, review_input_list, neg_review = train_dataset.get_batch(batch_idx_list)
        ...
        for batch_idx_list in val_batch_sampler:
            user_list, item_list, rating_list, review_input_list, neg_review = val_dataset.get_batch(batch_idx_list)
        ...
        for batch_idx_list in test_batch_sampler:
            user_list, item_list, rating_list, review_input_list, neg_review = test_dataset.get_batch(batch_idx_list)
