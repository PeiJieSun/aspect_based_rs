...
if __name__ == '__main__':
    ...
    for batch_idx_list in test_batch_sampler:
        user_list, item_list, review_input_list, review_output_list = test_dataset.get_batch(batch_idx_list)
        sample_idx_list = model._sample_text_by_top_one(user_list, item_list, review_input_list)
