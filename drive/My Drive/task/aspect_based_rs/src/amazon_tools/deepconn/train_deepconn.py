...
if __name__ == '__main__':
    ...
    #model.load_state_dict(torch.load('/content/drive/My Drive/task/aspect_based_rs/out/model/train_amazon_tools_aspect_deepconn_id_02.mod'))
    ...
    log = Logging('%s/train_%s_deepconn_id_04.py' % (conf.out_path, conf.data_name))
    train_model_path = '%s/train_%s_deepconn_id_04.mod' % (conf.out_path, conf.data_name)
